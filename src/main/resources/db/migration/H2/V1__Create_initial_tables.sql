CREATE TABLE daily_outcome (
  daily_outcome_id          INTEGER generated BY DEFAULT AS IDENTITY,
...
CREATE TABLE daily_outcome_category (
  daily_outcome_category_id  INTEGER generated BY DEFAULT AS IDENTITY,
...
CREATE TABLE income (
  income_id          INTEGER generated BY DEFAULT AS IDENTITY,
  amount             INTEGER      NOT NULL,
  created_at         TIMESTAMP    NOT NULL,
...
CREATE TABLE income_category (
  income_category_id INTEGER generated BY DEFAULT AS IDENTITY,
  category_name      VARCHAR(255) NOT NULL,
  created_at         TIMESTAMP    NOT NULL,
  updated_at         TIMESTAMP    NOT NULL,
  version            INTEGER,
...
CREATE TABLE monthly_outcome (
  monthly_outcome_id          INTEGER generated BY DEFAULT AS IDENTITY,
  amount                      INTEGER   NOT NULL,
  created_at                  TIMESTAMP NOT NULL,
  outcome_date                DATE      NOT NULL,
...
CREATE TABLE monthly_outcome_category (
  monthly_outcome_category_id INTEGER generated BY DEFAULT AS IDENTITY,
  category_name               VARCHAR(255) NOT NULL,
  created_at                  TIMESTAMP    NOT NULL,
...
CREATE TABLE parent_outcome_category (
  parent_outcome_category_id INTEGER generated BY DEFAULT AS IDENTITY,
  category_name              VARCHAR(255) NOT NULL,
  created_at                 TIMESTAMP    NOT NULL,
  updated_at                 TIMESTAMP    NOT NULL,
  version                    INTEGER,
