                ...
                for (z = 0; z < o; z++) {
                    if (v < r.length && (r[v].show || r[v].showLabel)) {
                        ...
                        if (n) {
                            ...
                            l.css({textAlign: "center", paddingTop: p});
                            ...
                            g.css({backgroundColor: x, borderColor: x});
                            l.append(h.append(g));
                            ...
                            if (this.seriesToggle) {
                                ...
                                if (this.showSwatches) {
                                    l.bind("click", {series: u, speed: A, plot: y, replot: this.seriesToggleReplot}, a);
                                    l.addClass("jqplot-seriesToggle")
                                }
                                if (this.showLabels) {
                                    k.bind("click", {series: u, speed: A, plot: y, replot: this.seriesToggleReplot}, a);
