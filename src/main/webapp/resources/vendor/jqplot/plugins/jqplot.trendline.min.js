...
(function (f) {
    ...
    function a(k) {
        ...
        if (k.trendline && k.trendline.show) {
            ...
            if (i) {
                j = {label: i, color: k.trendline.color}
            }
        }
        return j
    }
    ...
    function e(m, k, j, i, l) {
        if (this._type && (this._type === "line" || this._type == "bar")) {
            ...
            i = i || {};
            f.extend(true, this.trendline, {color: this.color}, j.trendline, i.trendline);
    ...
    function g(m, i) {
        ...
        if (this.trendline && i.show) {
            ...
            this.trendline.renderer.draw.call(this.trendline, m, j, {showLine: true, shadow: this.trendline.shadow})
        }
    }
    ...
    function c(l, j) {
        ...
        return{data: m, slope: n[0], intercept: n[1]}
    }
})(jQuery);