...
(function (f) {
    ...
    f.jqplot.BubbleRenderer.prototype.init = function (w, t) {
        ...
        var m = {fill: true, isarc: true, angle: this.shadowAngle, alpha: this.shadowAlpha, closePath: true};
    ...
    f.jqplot.BubbleRenderer.prototype.draw = function (D, J, n) {
        ...
        for (var G = 0; G < this.radii.length; G++) {
            ...
            if (this.shadow) {
                this.renderer.shadowRenderer.draw(D, [u, s, J[2], 0, 2 * Math.PI], {offset: q, depth: K})
            }
    ...
    f.jqplot.DivCanvas.prototype.createElement = function (s, p, n) {
        ...
        this._elem = f(r);
        this._elem.css({position: "absolute", width: o, height: q, left: this._offsets.left, top: this._offsets.top});
        this._elem.addClass(m);
        return this._elem
    };
    f.jqplot.DivCanvas.prototype.setContext = function () {
        this._ctx = {canvas: {width: 0, height: 0}, clearRect: function () {
            return null
        }};
        return this._ctx
    };
    ...
    f.jqplot.BubbleCanvas.prototype.createElement = function (n, u, s) {
        ...
        this._elem.css({position: "absolute", left: o, top: p});
        this._elem.addClass(m);
    ...
    function h() {
        ...
        this.plugins.bubbleRenderer.highlightLabelCanvas.css({top: q, left: p, width: n + "px", height: m + "px"});
